...
class CustomRenderer extends BaseRenderer
{
    ...
    protected function internalRender()
    {
        ...
        if ($this->isBootstrapTheme()) {
            Html::addCssClass($options, 'table form-horizontal tr-form');
        }
        ...
        return Html::tag('div', $content, [
            'id' => $this->id,
            'class' => 'multiple-input tr-tab-item tab-item',
            'style' => 'display:block'
        ]);
    }
    ...
    protected function prepareRowOptions($index, $item)
    {
        ...
        Html::addCssClass($options, 'multiple-input-list__item group-col');
...
//        if ($this->isBootstrapTheme()) {
//            Html::addCssClass($options, 'form-group tr-tab-item tab-items');
//        }
